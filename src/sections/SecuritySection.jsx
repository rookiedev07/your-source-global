      ...
      <div className="relative z-10">
        <ScrollReveal className="flex items-center justify-between mb-4 max-w-4xl mx-auto text-center flex-col">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="px-2.5 py-0.5 rounded text-[11px] font-mono font-bold bg-amber-500/20 border border-amber-500/40 text-amber-300">
              {SECURITY_CONTENT.badge}
            </span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-h2 font-display font-bold text-white tracking-tight leading-tight max-w-3xl">
            {SECURITY_CONTENT.title}
          </h2>
          <p className="mt-3 sm:mt-4 text-sm sm:text-base md:text-body-lg text-slate-300 max-w-2xl">
            ...
            return (
              ...
              >
                <div>
                  ...
                  <h3 className="text-lg sm:text-xl font-display font-bold text-white mb-2 sm:mb-2.5">
                    {tile.title}
                  </h3>
                  ...
                  <div className="space-y-2 pt-3 sm:pt-4 border-t border-navy-800">
        ...
        <ScrollReveal className="mt-12 sm:mt-14 p-6 sm:p-8 rounded-2xl bg-navy-900/80 border border-navy-800 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center text-xs font-bold px-5 py-2.5 rounded-lg bg-white text-navy-950 hover:bg-slate-100 transition-colors shrink-0 gap-2 w-full md:w-auto"
          >
