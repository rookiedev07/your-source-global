        ...
        {INDUSTRIES_CONTENT.industries.map((ind, idx) => {
          ...
          return (
            <ScrollReveal
              key={ind.id}
              delay={idx * 80}
              className="group p-8 rounded-2xl bg-white border border-slate-200 hover:border-navy-600/40 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-start justify-between gap-4 mb-5">
                  <div className="w-12 h-12 rounded-xl bg-navy-50 text-navy-800 group-hover:bg-navy-800 group-hover:text-white transition-colors duration-200 flex items-center justify-center shrink-0">
                ...
                <h3 className="text-xl font-display font-bold text-navy-900 mb-2.5">
                  {ind.name}
                </h3>
