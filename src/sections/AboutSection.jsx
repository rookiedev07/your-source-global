    ...
    >
      ...
      <div className="mt-14 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
        <ScrollReveal delay={100} className="lg:col-span-6 space-y-6">
          <div className="prose prose-slate max-w-none space-y-4 text-slate-600 text-sm md:text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
              ...
              <p className="text-xs text-slate-500 leading-normal">
                US &amp; Australia leadership for account management, governance, and SLA assurance.
              </p>
            </div>
          ...
          <div className="pt-2 flex flex-wrap gap-4 items-center">
            <Button href="#why-us" variant="primary" size="md" icon={ArrowRight}>
        ...
        <ScrollReveal delay={200} className="lg:col-span-6">
          <div className="p-8 md:p-10 rounded-2xl bg-gradient-to-br from-navy-900 via-navy-950 to-navy-900 text-white shadow-xl border border-navy-800 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-6 pt-4 border-t border-navy-800/80 flex items-center justify-between text-[11px] text-slate-400">
                ...
                <span className="font-mono text-slate-500">[CONFIRM STATS BEFORE LAUNCH]</span>
              </div>
            </div>
          </div>
        </ScrollReveal>
